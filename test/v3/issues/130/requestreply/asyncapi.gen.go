...
// NewPingWithIDMessage creates a new PingWithIDMessage with default values if any.
...
// NewPongWithIDMessage creates a new PongWithIDMessage with default values if any.
