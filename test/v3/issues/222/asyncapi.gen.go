...
// PublishV3Issue222Test will publish messages to 'v3.issue222.test' channel
func (c *AppController) PublishV3Issue222Test(
	ctx context.Context,
	msg V3Issue222TestMessage,
) error {
	// Get channel path
	path := "v3.issue222.test"
...
type UserSubscriber interface {
	// V3Issue222Test subscribes to messages placed on the 'v3.issue222.test' channel
	V3Issue222Test(ctx context.Context, msg V3Issue222TestMessage) error
}
...
func (c *UserController) SubscribeAll(ctx context.Context, as UserSubscriber) error {
	...
	if err := c.SubscribeV3Issue222Test(ctx, as.V3Issue222Test); err != nil {
		return err
	}
...
func (c *UserController) UnsubscribeAll(ctx context.Context) {
	c.UnsubscribeV3Issue222Test(ctx)
}

// SubscribeV3Issue222Test will subscribe to new messages from 'v3.issue222.test' channel.
//
// Callback function 'fn' will be called each time a new message is received.
func (c *UserController) SubscribeV3Issue222Test(
	ctx context.Context,
	fn func(ctx context.Context, msg V3Issue222TestMessage) error,
) error {
	// Get channel path
	path := "v3.issue222.test"
	...
	go func() {
		for {
			...
			if err := c.executeMiddlewares(ctx, &acknowledgeableBrokerMessage.BrokerMessage, func(ctx context.Context) error {
				// Process message
				msg, err := brokerMessageToV3Issue222TestMessage(acknowledgeableBrokerMessage.BrokerMessage)
				if err != nil {
					return err
				}
...
// UnsubscribeV3Issue222Test will unsubscribe messages from 'v3.issue222.test' channel.
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *UserController) UnsubscribeV3Issue222Test(ctx context.Context) {
	// Get channel path
	path := "v3.issue222.test"
...
// V3Issue222TestMessage is the message expected for 'V3Issue222TestMessage' channel.
type V3Issue222TestMessage struct {
	// Payload will be inserted in the message payload
	Payload TestSchema
}

func NewV3Issue222TestMessage() V3Issue222TestMessage {
	var msg V3Issue222TestMessage

	return msg
}

// brokerMessageToV3Issue222TestMessage will fill a new V3Issue222TestMessage with data from generic broker message
func brokerMessageToV3Issue222TestMessage(bMsg extensions.BrokerMessage) (V3Issue222TestMessage, error) {
	var msg V3Issue222TestMessage
...
// toBrokerMessage will generate a generic broker message from V3Issue222TestMessage data
func (msg V3Issue222TestMessage) toBrokerMessage() (extensions.BrokerMessage, error) {
...
const (
	// V3Issue222TestPath is the constant representing the 'V3Issue222Test' channel path.
	V3Issue222TestPath = "v3.issue222.test"
)
