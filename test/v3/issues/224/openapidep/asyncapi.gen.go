// Package "openapidep" provides primitives to interact with the AsyncAPI specification.
//
...
// PetSchema is a schema from the AsyncAPI specification required in messages
