...
func (suite *Suite) TestV1Reception() {
	...
	wg.Add(1)
	err := suite.v1.app.SubscribeIssue73Hello(context.Background(), func(_ context.Context, msg v1.Issue73HelloMessage) error {
		recvMsg = msg
		wg.Done()
		return nil
	})
	...
	err = suite.v2.app.SubscribeIssue73Hello(context.Background(), func(_ context.Context, _ v2.Issue73HelloMessage) error {
...
func (suite *Suite) TestV2Reception() {
	...
	// Check that the other app doesn't receive
	err := suite.v1.app.SubscribeIssue73Hello(context.Background(), func(_ context.Context, _ v1.Issue73HelloMessage) error {
		suite.Require().FailNow("this should not happen")
		return nil
	})
	suite.Require().NoError(err)
	...
	wg.Add(1)
	err = suite.v2.app.SubscribeIssue73Hello(context.Background(), func(_ context.Context, msg v2.Issue73HelloMessage) error {
		recvMsg = msg
		wg.Done()
		return nil
	})
