...
type AppSubscriber interface {
	...
	Issue49Chat(ctx context.Context, msg Issue49ChatSubscribeMessage)
}
...
func (c *AppController) SubscribeIssue49Chat(ctx context.Context, fn func(ctx context.Context, msg Issue49ChatSubscribeMessage)) error {
	// Get channel path
	path := "issue49.chat"
	...
	go func() {
		for {
			...
			if err := c.executeMiddlewares(ctx, &brokerMsg, func(ctx context.Context) error {
				// Process message
				msg, err := newIssue49ChatSubscribeMessageFromBrokerMessage(brokerMsg)
				if err != nil {
					return err
				}
...
//
// Callback function 'fn' will be called each time a new message is received.
func (c *UserController) SubscribeIssue49Chat(ctx context.Context, fn func(ctx context.Context, msg Issue49ChatSubscribeMessage)) error {
	// Get channel path
	path := "issue49.chat"
